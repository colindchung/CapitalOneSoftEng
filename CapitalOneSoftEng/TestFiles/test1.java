...
/*
*
* @Configuration tags the class as a source of bean definitions for the applicationcontext.
*
* @EnableAutoConfiguration tells Spring Boot to start adding beans based on classpath settings, other beans, and various property setting
*
...
public class Application {
 ...
 System.out.println("Let's inspect the bea//ns provided by Spring Boot:");
